...
Public Class frmMdi_Parent
    ...
    Private Sub btnOpenChild_Click(sender As System.Object, e As System.EventArgs) Handles btnOpenChild.Click
        Dim f As New frmMdi_Child
        Dim ReturnData As String = ""

        If Not IsOpen(f) Then                            'if child form is already open set focus to the form
            f.Message = txtMessage.Text                  'call the overrided constructor of the child form
